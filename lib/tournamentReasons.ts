...
export const TOURNAMENT_REASONS: Record<string, string> = {
  ...
  invite_already_sent:           'Tu lui as déjà envoyé une invitation pour cette soirée.',
  partner_not_registered:        'Le joueur qui t’a invité s’est désinscrit entre-temps.',
  tournament_full:               'Plus de place assise : la soirée s’est remplie pendant que tu répondais.',
