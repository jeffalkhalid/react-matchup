...
const Colors = {
  ...
  bg: '#F5F5F4',
  bgCard: '#FFFFFF',
  // Blanc pur (plus de crème/off-white) : surface secondaire alignée sur les cartes.
  bgCardAlt: '#FFFFFF',
  // Ex-crème (#FAF5E8) neutralisé en blanc pur partout (cartes de partage Stories,
  // thème « Crème » des invitations, classe Tailwind `cream` incluses).
  bgCream: '#FFFFFF',
