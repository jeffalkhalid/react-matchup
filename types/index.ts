...
export interface Player {
  ...
  first_name?: string | null;  // identité civile saisie à l'inscription
  last_name?: string | null;
  /** Afficher le vrai nom sous le pseudo. Vrai par défaut ; ignoré pour un
   *  joueur lié au classement FRMT, dont le nom vient de la fédération. */
