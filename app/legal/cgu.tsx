    ...
    >
      ...
      <Section n={4} icon="📸" title="Vos contenus">
        <P>
          ...
          commentaires) et garantissez en détenir les droits. Vous nous accordez une licence limitée et
          non exclusive, aux seules fins de faire fonctionner le Service.
        </P>
      </Section>
