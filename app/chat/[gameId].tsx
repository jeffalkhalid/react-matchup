      ...
      <View style={{ backgroundColor: Colors.heroBg, paddingTop: insets.top + 6 }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 14, paddingBottom: 10 }}>
          ...
          <View style={{ flex: 1, minWidth: 0 }}>
            <Text style={{ fontSize: 22, lineHeight: 29, fontFamily: Fonts.welcome, color: Colors.textOnDark, letterSpacing: 0.2, paddingRight: 5 }} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.6}>
