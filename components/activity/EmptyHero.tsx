...
export function EmptyHero({ variant, subtitle, ctaLabel, onPress }: {
  ...
  return (
    <View style={{ borderRadius: 18, padding: 16, marginTop: 14, backgroundColor: Colors.bgDark }}>
      ...
      <Text numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.6} style={{ fontFamily: Fonts.welcome, fontSize: 22, color: Colors.textOnDark, lineHeight: 29, paddingRight: 5 }}>{title}</Text>
