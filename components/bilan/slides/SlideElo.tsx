  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', paddingHorizontal: 30, paddingTop: 12, paddingBottom: 34 }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'baseline', gap: 6, marginTop: 24 }}>
        <Text style={{ fontFamily: Fonts.display, fontSize: 48, color: deltaColor, lineHeight: 62 }}>{up ? '+' : '−'}</Text>
        <Text style={{ fontFamily: Fonts.display, fontSize: 110, color: deltaColor, lineHeight: 143, letterSpacing: -3 }}>{Math.abs(recap.levelDelta).toFixed(2)}</Text>
      </View>
      <Text style={{ fontFamily: Fonts.welcome, fontSize: 24, color: '#FFFFFF', lineHeight: 31, marginTop: -2 }}>de niveau</Text>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 18 }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 10, paddingHorizontal: 10, paddingVertical: 5 }}>
          <Text style={{ fontFamily: Fonts.display, fontSize: 14, lineHeight: 18, color: '#67E8F9' }}>{recap.fromLvl.toFixed(2)}</Text>
          ...
          <Text style={{ fontFamily: Fonts.display, fontSize: 18, lineHeight: 23, color: '#67E8F9' }}>{recap.toLvl.toFixed(2)}</Text>
        </View>
      </View>
